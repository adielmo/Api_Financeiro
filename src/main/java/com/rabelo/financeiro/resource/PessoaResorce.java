...
import com.rabelo.financeiro.service.PessoaService;
...
public class PessoaResorce {
	...
	public Page<Pessoa> pesquisar(PessoaFilter pessoaFilter, Pageable pageable) {
		return pessoaRepository.filtrar(pageable, pessoaFilter);
	}
	...
	public ResponseEntity<Pessoa> buscarPeloCodigo(@PathVariable Long codigo) {
		Optional<Pessoa> pessoaCodigo = pessoaRepository.findById(codigo);

		return pessoaCodigo.isPresent() ? ResponseEntity.ok(pessoaCodigo.get()) : ResponseEntity.notFound().build();
	}
	 ...
	 * atualizarParcial(@PathVariable Long codigo, @RequestBody Map<String, Object>
	 * pessoas) { pessoaService.atualizarParcialmente(codigo, pessoas); }
	 */
